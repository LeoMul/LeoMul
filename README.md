...
On this page you'll find utility codes for Atomic Data processing, modelling and generation. These include the comparison of atomic data sets, the streamlining of atomic data code runs, and spectral modelling through collisional radiative modelling - including the impact of non thermal electrons. I prefer to code typically in Python, Fortran, and Rust. I have C/C++ code hosted here too.  
